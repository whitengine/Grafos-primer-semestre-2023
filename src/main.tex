...
Claramente, todo matching en nuestra secuencia es mejor que las anteriores y mantiene a los vértices de $X$ felices, los cuales lo estaban desde el principio, pues empezamos con el matching vacío. Así, la secuencia continua hasta encontrar un matching $M$ que no tiene vértices de $X$ sin cubrir y que sea aceptable para algún vecino en $Y$. Como todo vértice en $X$ es feliz con $M$, este matching es estable.
\end{proof}
