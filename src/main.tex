...
\end{exercise}
\begin{solution}
Por el Teorema de Hall \ref{th:teorema de Hall}, basta ver que $S \subset Y$ cumple la condición de Hall \eqref{eq:condicion de Hall} para todo $S$ no vacío. Para eso, notar que el conjunto de vértices $(Y \setminus S) \cup N(S)$ cubre todas las aristas de $G$, por lo tanto
\[
